    ...
    public class AccountingTransactionManager : Manager
    {
            ...
            return new Booking
                       {
                           ...
                           Maker = reader.GetString("maker_id"),
                           Checker = reader.GetString("checker_id"),
                           TypeOfTransaction = reader.GetString("type_of_transaction"),
        ...
        public void InsertManualMovment(Booking booking, SqlTransaction sqlTransaction)
        {
            ...
            using (OpenCbsCommand command = new OpenCbsCommand(sqlText, sqlTransaction.Connection, sqlTransaction))
            {
                ...
                command.AddParam("@maker_id", booking.Maker);
                command.AddParam("@checker_id", booking.Checker);
                command.AddParam("@type_of_transaction", booking.TypeOfTransaction);
