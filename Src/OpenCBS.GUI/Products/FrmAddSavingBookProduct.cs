    ...
    public partial class FrmAddSavingBookProduct : SweetBaseForm
    {
        ...
        private void btSavingProduct_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               {
                   SavingProductServices _SavingProductServices = ServicesProvider.GetInstance().GetSavingProductServices();

                   _SavingProductServices.SaveProduct(_savingsProduct, clientTypeCounter);
               }
