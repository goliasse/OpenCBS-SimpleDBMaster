...
namespace OpenCBS.GUI.Products
{
    public partial class FrmAddFixedDepositProduct : SweetBaseForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            double InitialAmountMax = Convert.ToDouble(tbInitialAmountMax.Text);
            double InitialAmountMin = Convert.ToDouble(tbInitialAmountMin.Text);
            ...
            double MaturityPeriodMin = Convert.ToDouble(tbMinMaturityPeriod.Text);
            double MaturityPeriodMax = Convert.ToDouble(tbMaxMaturityPeriod.Text);
