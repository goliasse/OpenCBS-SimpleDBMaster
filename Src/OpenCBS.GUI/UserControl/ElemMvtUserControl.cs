...
namespace OpenCBS.GUI.UserControl
{
	...
	public class ElemMvtUserControl : System.Windows.Forms.UserControl
	{
        ...
        private ComboBox cbTypeOfTransaction;
        private Label label2;
        private ComboBox cbChecker;
        private Label lblMaker;
        private ComboBox cbMaker;
        ...
        private void _Initialization(Loan pContract, bool pDeleteIsPossible)
        {
            ...
            _InitializeMakerAndChecker();
        }

        private void _InitializeMakerAndChecker()
        {
		...
		private void InitializeComponent()
		{
            ...
            this.cbTypeOfTransaction = new System.Windows.Forms.ComboBox();
            ...
            this.groupBoxMvts.Controls.Add(this.label3);
            this.groupBoxMvts.Controls.Add(this.cbTypeOfTransaction);
            this.groupBoxMvts.Controls.Add(this.label2);
            this.groupBoxMvts.Controls.Add(this.cbChecker);
            this.groupBoxMvts.Controls.Add(this.lblMaker);
            this.groupBoxMvts.Controls.Add(this.cbMaker);
            ...
            this.groupBoxMvts.Enter += new System.EventHandler(this.groupBoxMvts_Enter);
            // 
            // label3
            // 
            ...
            // cbTypeOfTransaction
            // 
            this.cbTypeOfTransaction.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            resources.ApplyResources(this.cbTypeOfTransaction, "cbTypeOfTransaction");
            this.cbTypeOfTransaction.Items.AddRange(new object[] {
            resources.GetString("cbTypeOfTransaction.Items"),
            resources.GetString("cbTypeOfTransaction.Items1"),
            resources.GetString("cbTypeOfTransaction.Items2")});
            this.cbTypeOfTransaction.Name = "cbTypeOfTransaction";
            // 
            // label2
            // 
            ...
            resources.ApplyResources(this.cbMaker, "cbMaker");
                ...
                Booking booking = new Booking
                                      {
                                          ...
                                          Maker = cbMaker.SelectedItem.ToString(),
                                          Checker = cbChecker.SelectedItem.ToString(),
                                          TypeOfTransaction = cbTypeOfTransaction.SelectedItem.ToString(),
        ...
        private void groupBoxMvts_Enter(object sender, EventArgs e)
        {
